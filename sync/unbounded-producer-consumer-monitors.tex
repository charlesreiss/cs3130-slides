...
\begin{tikzpicture}[overlay,remember picture]
    ...
    \coordinate (place lower) at ([xshift=-.5cm,yshift=-4.5cm]current page.north east);
    \tikzset{
    ...
    \begin{visibleenv}<5->
        ...
        node[fill=white,draw=red,right,align=left,font=\small] {
        ...
        \tikzset{
            timeline/.style={
                ...
                nodes={text width=3.5cm,font=\fontsize{11}{12}\selectfont,fill=white,text depth=0.075cm,text height=0.25cm},
                at={([xshift=-0.75cm,yshift=-1.25cm]current page.north east)},
                anchor=north east,
