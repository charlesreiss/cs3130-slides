...
\subsection{the cache coherency problem}
...
\subsection{snooping preview} 

\begin{frame}{``snooping'' the bus}
\begin{itemize}
\item every processor already \myemph{receives every read/write to memory}
