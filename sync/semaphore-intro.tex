...
\begin{visibleenv}<6>
    ...
    \draw[thick,blue,<-] (semaphore.south) -- ++(.5cm,-.5cm) node[right,circle,fill=blue,label={[align=left,text=blue!70!black]south east:{\underline{\textbf{reserve book}} \\ call \textit{down} \\ \sout{waiting} \\ done waiting}}] {};
