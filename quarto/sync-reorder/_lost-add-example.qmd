...
![](/sync-reorder/parallel-add-histogram.svg){fig-alt="histogram of actual measurements showing results clustered in around 1 million; with most slightly above that and a few below that. The histogram has no visible results above around 1.3 million."}
