...
Which of these (all run in parallel) can deadlock? <br>
 <table>
...
<tr><td>D. A and C</td></tr>
<tr><td>E. B and C</td></tr>
<tr><td>F. all of the above</td></tr>
<tr><td>G. none of the above</td></tr>
</table>
...
<table>
<tr><td>RemoveNode(B)</td><td>RemoveNode(C)</td></tr>
