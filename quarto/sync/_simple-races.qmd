...
* what are the possible values of $x$? (initially $x = y = 0$)  <br> <table>
...
* possible values of $x$? (initially $x = y = 0$) <br> <table>
   <tr><td><em>Thread A</em></td><td><em>Thread B</em></td></tr>
...
* (initially $x = y = 0$) <br> <table>
   <tr><td><em>Thread A</em></td><td><em>Thread B</em></td></tr>
<tr><td><!-- \hline -->  $x \leftarrow 1$</td><td>$x \leftarrow 2$</td></tr>
<tr><td></td></tr>
</table>
