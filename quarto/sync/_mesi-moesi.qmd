...
* have to update memory to share a modified value … even though caches <em>read from other caches</em>
* read from which cache?


### scheme 3: MOESI 

![](/sync/texfig/moesiGraph.figure.svg)
...
::: {.r-stack .my-full}
![](/sync/texfig/mesi-moesi-moesi-example.figure-1.svg){.fragment .fade-in-then-out fragment-index=1}

![](/sync/texfig/mesi-moesi-moesi-example.figure-2.svg){.fragment .fade-in-then-out fragment-index=2}

![](/sync/texfig/mesi-moesi-moesi-example.figure-3.svg){.fragment .fade-in-then-out fragment-index=3}

![](/sync/texfig/mesi-moesi-moesi-example.figure-4.svg){.fragment .fade-in-then-out fragment-index=4}

![](/sync/texfig/mesi-moesi-moesi-example.figure-5.svg){.fragment .fade-in-then-out fragment-index=5}

![](/sync/texfig/mesi-moesi-moesi-example.figure-6.svg){.fragment .fade-in-then-out fragment-index=6}

![](/sync/texfig/mesi-moesi-moesi-example.figure-7.svg){.fragment .fade-in-then-out fragment-index=7}
