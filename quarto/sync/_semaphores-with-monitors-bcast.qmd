...
::: {.r-stack .my-full}
![](/sync/texfig/semaphores-with-monitors-bcast-broadcast-problem.figure-1.svg){.fragment .fade-in-then-out fragment-index=1}

![](/sync/texfig/semaphores-with-monitors-bcast-broadcast-problem.figure-2.svg){.fragment .fade-in-then-out fragment-index=2}

![](/sync/texfig/semaphores-with-monitors-bcast-broadcast-problem.figure-3.svg){.fragment .fade-in-then-out fragment-index=3}
