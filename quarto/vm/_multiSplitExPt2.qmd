...
* page table base register <code>0x20</code>; translate virtual address <code>0x129</code>
 

::: {.r-stack}
![](/vm/texfig/multiSplitExPt2-2-level-example.figure-1.svg){.fragment .fade-in-then-out fragment-index=1}

![](/vm/texfig/multiSplitExPt2-2-level-example.figure-2.svg){.fragment .fade-in-then-out fragment-index=2}

![](/vm/texfig/multiSplitExPt2-2-level-example.figure-3.svg){.fragment .fade-in-then-out fragment-index=3}

![](/vm/texfig/multiSplitExPt2-2-level-example.figure-4.svg){.fragment .fade-in-then-out fragment-index=4}

![](/vm/texfig/multiSplitExPt2-2-level-example.figure-5.svg){.fragment .fade-in-then-out fragment-index=5}

![](/vm/texfig/multiSplitExPt2-2-level-example.figure-6.svg){.fragment .fade-in-then-out fragment-index=6}
