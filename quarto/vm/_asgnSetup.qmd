...
::: {.r-stack}
![](/vm/texfig/asgnSetup-translate.figure-1.svg){.fragment .fade-out fragment-index=2 style="height: 450px"}

![](/vm/texfig/asgnSetup-translate.figure-2.svg){.fragment .fade-in-then-out fragment-index=2 style="height: 450px"}
...
::: {.r-stack}
![](/vm/texfig/asgnSetup-allocate_page.figure-1.svg){.fragment .fade-out fragment-index=2 style="height: 450px"}

![](/vm/texfig/asgnSetup-allocate_page.figure-2.svg){.fragment .fade-in-then-out fragment-index=2 style="height: 450px"}

![](/vm/texfig/asgnSetup-allocate_page.figure-3.svg){.fragment .fade-in-then-out fragment-index=3 style="height: 450px"}
