...
\matrix[tight matrix,
    nodes={font=\fontsize{7.5}{8.5}\selectfont,minimum height=.35cm},
    column 1/.style={nodes={text width=1cm,font=\fontsize{7.5}{8.5}\selectfont\tt,text depth=.1cm}},
...
\matrix[tight matrix no line,
    nodes={font=\fontsize{9}{10}\selectfont,text width=0.8cm,align=right,minimum height=.4cm},
    ...
    row 1/.style={nodes={font=\fontsize{9}{10}\selectfont\it}},
    anchor=north west
