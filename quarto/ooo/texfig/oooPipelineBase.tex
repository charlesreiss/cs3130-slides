\newcommand{\oooPipelineStyles}{
\tikzset{
    every node/.style={font=\fontsize{8.5}{9.5}\selectfont},
    every label/.style={font=\fontsize{8.5}{9.5}\selectfont,align=center},
    node distance=4mm,
    >=Latex,
    ...
    hilite now/.style={fill=red!20,draw=red},
    predict/.style={},
    rename/.style={},
    issuequeue/.style={},
    regread/.style={},
...
\node[issuequeue,iqueue,on chain,label={north:instr.\\queue(s)}] (iqueue) {};
...
\node[cache,anchor=east,issuequeue] (regready) at ([xshift=.025cm]regfile.west) {reg.\\ready\\info};
