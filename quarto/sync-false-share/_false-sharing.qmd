...
![](/sync-false-share/sum-up.svg){fig-alt="Graph of time (in cycles) versus distance between array elements in bytes, showing times around 47 million cycles from 0 to around 60 bytes, then around 34 million cycles from 64 bytes and upwards."}
