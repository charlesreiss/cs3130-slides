...
### contrived(?) vulnerable code (1)  {.smaller}
...
### the out-of-bounds access (1)  {.smaller}
...
### the out-of-bounds access (2)  {.smaller}
...
### the out of bounds access (2) soln  {.smaller}
...
### exploit with contrived(?) code  {.smaller}
