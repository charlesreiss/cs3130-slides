...
```
 \\tikzmark{question start}[]{.my-small} Exercise: Suppose the pid of the parent process is <code>99</code> and child is <code>100</code>. Give <em>two</em> possible outputs. (Assume no crashes, etc.) <!--
```
