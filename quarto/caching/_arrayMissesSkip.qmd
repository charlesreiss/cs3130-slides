...
* [Assume everything but `array1`, `array2` is kept in registers (and the compiler does not do anything funny).]{.my-small}
* About how many _data cache misses_ on a 2KB direct-mapped cache with 16B cache blocks?
<br>Hint: depends on relative placement of `array1`, `array2`
