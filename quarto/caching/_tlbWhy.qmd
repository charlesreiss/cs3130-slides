...
### page table entry cache {.smaller}
...
<tr><td>bytes from memory</td><td>[[page table entries]{.fragment fragment-index=2 .custom .myem-only}]{.fragment fragment-index=3 .custom .myem-only}</td></tr>
...
::: {.myoverbox .vlow .fragment .fade-in-then-out fragment-index=6}
