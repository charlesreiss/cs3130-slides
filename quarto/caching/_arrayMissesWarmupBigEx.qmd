...
```
 [ Assume everything but <code>array</code> is kept in registers (and the compiler does not do anything funny).<br> observation: array[0] and array[512] exactly 2KB apart]{.my-small} 
