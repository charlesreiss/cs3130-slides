...
\draw[very thick,decorate,decoration={brace,mirror}] ([xshift=-.1cm]cache-2-1.north west) -- ([xshift=-.1cm]cache-5-1.south west);
...
\draw[very thick,decorate,decoration={brace}] ([yshift=.05cm]tag.north west) -- ([yshift=.05cm]idx.north east)
    node [midway,above,alt=<2>{red}] {VPN};

\draw[very thick,black!80,decorate,decoration={brace}] ([yshift=.05cm]po.north west) -- ([yshift=.05cm]po.north east)
