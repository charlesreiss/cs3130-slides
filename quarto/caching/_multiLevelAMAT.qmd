...
* what is the average memory access time for the L1 cache? 
   ...
   * \\iftoggle{heldback&nbsp;$3 + 0.1\\cdot{}([10 + 0.2\\cdot100{}]{.fragment fragment-index=3 .custom .myem-only}) = 6$ cycles}
   * \\iftoggle{heldback&nbsp;L1 miss penalty is $10 + 0.2\\cdot100{} = 30$ cycles}
