...
# tag-index-offset {visibility="hidden"}
...
## sizing a direct mapped cache {visibility="hidden"}

{{< include /caching/_sizeExercise.qmd >}}
...
# C code and caches {visibility="hidden"}

## array misses exercises {visibility="hidden"}

{{< include /caching/_arrayMissesWarmupAOrdered.qmd >}}
{{< include /caching/_arrayMissesWarmupBInterleaved.qmd >}}
{{< include /caching/_arrayMissesWarmupDTwoSetEvenOdd.qmd >}}
{{< include /caching/_arrayMissesWarmupEBig.qmd >}}
...
## array misses exercise (associative) {visibility="hidden"}

{{< include /caching/_arrayMissesWarmupFBigAssociative.qmd >}}
...
# cache design and memory performance {visibility="hidden"}
