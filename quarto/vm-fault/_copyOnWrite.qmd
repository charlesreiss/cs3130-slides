...
::: {.r-stack .my-full}
![](/vm-fault/texfig/copyOnWrite-pt-only.figure-1.svg){.fragment .fade-out fragment-index=2}

![](/vm-fault/texfig/copyOnWrite-pt-only.figure-2.svg){.fragment .fade-in-then-out fragment-index=2}

![](/vm-fault/texfig/copyOnWrite-pt-only.figure-3.svg){.fragment .fade-in-then-out fragment-index=3}

![](/vm-fault/texfig/copyOnWrite-pt-only.figure-4.svg){.fragment .fade-in-then-out fragment-index=4}
