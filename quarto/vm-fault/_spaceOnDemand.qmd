...
![](/vm-fault/texfig/spaceOnDemand-space-on-demand.figure-1.svg){.fragment .fade-out fragment-index=1 fig-alt="Program memory layout with a zoom-in on many pages of stack space."}

![](/vm-fault/texfig/spaceOnDemand-space-on-demand.figure-2.svg){.fragment .fade-in fragment-index=1 fig-alt="Only the topmost 12 KB of stack space (three pages) is used; the rest is wasted space."}
...
::: {.r-stack .my-full}
![](/vm-fault/texfig/spaceOnDemand.figure-1.svg){.fragment .fade-out fragment-index=2}

![](/vm-fault/texfig/spaceOnDemand.figure-2.svg){.fragment .fade-in-then-out fragment-index=2}

![](/vm-fault/texfig/spaceOnDemand.figure-3.svg){.fragment .fade-in-then-out fragment-index=3}
