...
![](/vm-format/texfig/multiSplitExPt2-2-level-splitting.figure-1.svg){.absolute top="0%" left="0%" width=1050 height=600 .my-center  .fragment .fade-in-then-out fragment-index=1}
![](/vm-format/texfig/multiSplitExPt2-2-level-splitting.figure-2.svg){.absolute top="0%" left="0%" width=1050 height=600 .my-center  .fragment .fade-in-then-out fragment-index=2}
![](/vm-format/texfig/multiSplitExPt2-2-level-splitting.figure-3.svg){.absolute top="0%" left="0%" width=1050 height=600 .my-center  .fragment .fade-in-then-out fragment-index=3}
![](/vm-format/texfig/multiSplitExPt2-2-level-splitting.figure-4.svg){.absolute top="0%" left="0%" width=1050 height=600 .my-center  .fragment .fade-in-then-out fragment-index=4}
...
<tr><td>[0x3C-3F]{.myem-only .custom .fragment fragment-index=5}</td><td>EC [DC]{.myem-only .custom .fragment fragment-index=6} EC FC</td></tr>
</table>
...
<div class="fragment nomargin unhidecolors custom" data-fragment-index=10>
0x129 = [1 00]{.fragment fragment-index=3 .custom .myem-only .colorOne}[10 1]{.fragment fragment-index=6 .custom .myem-only .colorTwo}[001]{.fragment fragment-index=8 .custom .myem-only .colorThree} <br/>
