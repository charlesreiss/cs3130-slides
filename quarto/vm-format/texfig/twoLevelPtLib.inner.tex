...
\tikzset{
    ...
    memAccess/.style={alt=<8>{red, very thick}},
    pageNumberExpand/.style={alt=<5>{draw=red,very thick}},
...
\begin{visibleenv}<5>
\node[draw=red,thick,fill=white,fill opacity=0.9,anchor=south,align=center] at ([yshift=1cm]timesSize.north) {
    have physical page number \\
    need address of first byte of page \\
    alternative: add all-zero page offset
};
\end{visibleenv}
\end{tikzpicture}
