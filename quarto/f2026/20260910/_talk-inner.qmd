...
*  some tweaks to exception timeline question
   *  phrasing adjusted
   *  rare corner case where key was wrong for step 1 of timer case (fixed for new variants; don't think this actually affected anyone?)
