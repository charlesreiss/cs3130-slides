\begin{frame}{motivation for hashes: summary for signature}
    ...
    \item solution: get secure ``summary'' of message
        \begin{itemize}
        \item also useful for other tasks
        \end{itemize}
    \end{itemize}
\end{frame}
...
\begin{frame}{cryptographic hash}
    ...
    \item example uses:
        ...
        \item building tools for storing passwords/generating keys from passwords
            \begin{itemize}
                \item (but don't just use plain hash --- too easy to guess passwords)
            \end{itemize}
        \end{itemize}
