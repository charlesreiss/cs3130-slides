...
\begin{frame}{some avenues for review}
    ...
    \item review CSO1 stuff
        \begin{itemize}
        \item labs 10--13, homeworks 7--8 of last Spring
...
\begin{frame}{some pointer stuff} % FIXME: complex to make alt text for
\begin{tikzpicture}
\begin{scope}[y=0.9cm]
...
\node[right] at (bad ptr single.east) {compile error (hopefully)};
