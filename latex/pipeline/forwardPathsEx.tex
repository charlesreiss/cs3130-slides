...
\end{tikzpicture}
\begin{itemize}
\item in subq, \%r8 is \rule{3cm}{2pt} addq. \vspace{-.1cm}
\item in xorq, \%r9 is \rule{3cm}{2pt} addq. \vspace{-.1cm}
\item in andq, \%r9 is \rule{3cm}{2pt} addq. \vspace{-.1cm}
\item in andq, \%r9 is \rule{3cm}{2pt} xorq. \vspace{-.1cm}
    \begin{itemize}
    \item assume regfile cannot read value while being written
