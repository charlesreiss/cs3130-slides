\begin{frame}{collaboration (1)}
    \begin{itemize}
    \item labs --- you can/should work with other \textit{students}
        \begin{itemize}
...
\begin{frame}{generative AI tools}
    \begin{itemize}
    \item can use for things you might ask fellow/former student for individual assignment
        \begin{itemize}
        \item use should be cited in relevant submission
        \item \textit{not} an `extra lab partner'
        \end{itemize}
    \vspace{.5cm}
    \item cannot use for things you cannot ask fellow/former student for individual assignment
        \begin{itemize}
        \item write some code/written answer
        \item look over my written answer, tell me if it's okay
