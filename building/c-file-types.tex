...
\begin{frame}{files in building C programs}
\begin{tikzpicture}
\tikzset{
    ...
    compile/.style={alt={<2>{red!50!orange}},alt=<3>{invisible}},
    compile alt/.style={alt={<2>{red!50!magenta}},alt=<3>{invisible}},
...
{\tt .c} & & C source code \\
{\tt .h} & & C header file  \\
{\tt .s} & (or {\tt .asm}) & assembly file \\
{\tt .o} & (or {\tt .obj}) & object file (binary of assembly) \\
(none) & (or {\tt .exe}) & executable file \\
.a & (or {\tt .lib}) & statically linked library [collection of .o files] \\
.so & (or {\tt .dll}) & dynamically linked library [`shared object'] \\
\end{tabular}
\end{frame}
