...
\begin{frame}
    \frametitle{logistics note}
    \begin{itemize}
    \item (this might change depending how lectures go)
    \item pipeline HW due after thanksgiving break
    \item will cover relevant material next week
        \begin{itemize}
        \item probably mostly next Tuesday
        \end{itemize}
    \item OOO HW (shorter) due Friday after that
    \end{itemize}
\end{frame}
